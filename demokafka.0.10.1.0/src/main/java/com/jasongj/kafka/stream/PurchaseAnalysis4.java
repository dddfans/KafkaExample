...
public class PurchaseAnalysis4 {

	public static void main(String[] args) throws IOException, InterruptedException {
		Properties props = new Properties();
		props.put(StreamsConfig.APPLICATION_ID_CONFIG, "streams-purchase-analysis4");
		...
		kStream.map((Windowed<String> window, GroupInfo groupInfo) -> {
			...
			}).to(Serdes.String(), Serdes.String(), "my-result");
	...
	public static class GroupInfo{
		...
		private List<GroupItemInfo> sortBySumDesc(Collection<GroupItemInfo> allItems){
		    ...
		    Collections.sort(result, new Comparator<GroupItemInfo>(){
				@Override
				public int compare(GroupItemInfo o1, GroupItemInfo o2) {
