...
public class PurchaseAnalysis2 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		props.put(StreamsConfig.APPLICATION_ID_CONFIG, "streams-purchase-analysis10");
...
//		kTable.foreach((str, dou) -> System.out.printf("%s-%s\n", str, dou));
	...
	public static class GroupInfo{
		...
		public String toString() {
			return "GroupInfo [orderCount=" + orderCount + ", itemCount=" + itemCount + ", amountSum=" + amountSum
					+ "]";
		}
	}
